...
namespace BookingForm.Migrations
{
    ...
    [Migration("20190715101830_add confirmation to batch")]
    partial class addconfirmationtobatch
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookingForm.Models.Details", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BookingForm.Models.Storage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BookingForm.Models.Apartment", b =>
                {
                    ...
                    b.HasOne("BookingForm.Models.Batch", "Batch")
                        .WithMany()
                    ...
                    b.HasOne("BookingForm.Models.Storage")
                        .WithMany("Apartments")
            ...
            modelBuilder.Entity("BookingForm.Models.Batch", b =>
                {
                    b.HasOne("BookingForm.Models.Storage", "Storage")
                        .WithMany()
                        .HasForeignKey("StorageId");
                });
